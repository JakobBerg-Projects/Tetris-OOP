...
public void testShiftedToTopCenterOf(){
    // Test for a 4x4 Tetromino and even number of columns
        Tetromino tetro4x4 = Tetromino.newTetromino('O');
        GridDimension gridDim4x4 = new GridDimension(4, 6);
        Tetromino shiftedTetro4x4 = tetro4x4.shiftedToTopCenterOf(gridDim4x4);
        assertEquals(0, shiftedTetro4x4.iterator().next().pos().row());
        assertEquals(1, shiftedTetro4x4.iterator().next().pos().col());
        //TODO IMPLEMENT THIS
